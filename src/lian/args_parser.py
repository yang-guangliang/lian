...
class ArgsParser:
    ...
    def init(self):
        ...
        for parser in [parser_lang, parser_semantic, parser_security, parser_run]:
            ...
            parser.add_argument("--enable-p3-taint-guided", action="store_true", help="Enable taint-guided pruning for Phase III (global semantic analysis)")
