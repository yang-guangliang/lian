...
“莲花”Lian是新一代的程序分析框架。Lian采用“多语言统一”的设计理念，将所支持的语言统一转换为通用中间表示GIR（General Intermediate Representation），并在此基础上进行统一的语义分析与安全检测。只需为新语言适配轻量级前端，即可快速实现上下文敏感、流敏感的指针级代码分析能力。
