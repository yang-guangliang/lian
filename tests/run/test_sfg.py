...
class sfgTestCase(unittest.TestCase):
    ...
    def compare_sfg(cls, symbols_states, stmt_status, target_file):
        space_path = os.path.join(init_test.RESOURCE_DIR, "state_flow", "standard_results", f"{target_file}.space")
        status_path = os.path.join(init_test.RESOURCE_DIR, "state_flow", "standard_results", f"{target_file}.status")
    ...
    def setUpClass(cls):
        ...
        cls.tests = get_all_tests(os.path.join(init_test.RESOURCE_DIR, "state_flow/verified_cases"))
